...
TODO:
-Find out what every parameter is for
...
class Config:
    def __init__(self, config_type="normal"):
        ...
        # Self play
        self.num_actors = 64  # was 5000, but i guess this is number of processes, so we must change this
        ...
        self.window_size = 1000  # Max number of games in buffer (Should not exceed RAM!)
        ...
        self.c_puct = 3  # Where does these come from? (Find in the paper)
        ...
        if config_type == "test":
            ...
            self.num_threads = 16
            self.max_moves = 40
            self.max_games_in_buffer = 9
            self.vram_frac = 0.4

            self.window_size = 10000  # Max number of games in buffer (Should not exceed RAM!)
            self.batch_size = 4096

            self.cnn_filter_num = 1600
            self.cnn_filter_size = 3
        ...
        if config_type == "small":
            ...
            self.num_threads = 12
            self.max_moves = 50
            self.max_games_in_buffer = 50
            self.vram_frac = 0.5

            self.window_size = 40
            self.batch_size = 32

            self.cnn_filter_num = 4096
            self.cnn_filter_size = 3
